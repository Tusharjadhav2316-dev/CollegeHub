  ...
  return (
    <div className="w-full max-w-md space-y-6 rounded-2xl border border-slate-100 bg-white p-8 shadow-xl">
      ...
      <div className="relative flex items-center justify-center my-6">
        ...
        <span className="relative bg-white px-4 text-xs font-medium text-slate-500 uppercase">
          Or continue with
        </span>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          ...
          disabled={loading}
          className="flex items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 hover:bg-slate-50 active:bg-slate-100 transition-colors disabled:opacity-50"
        >
